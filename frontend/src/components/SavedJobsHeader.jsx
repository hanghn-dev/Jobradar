...
const SavedJobsHeader = () => {
  const { savedJobs } = jobsStore();
  return (
    <header className="w-full border-b border-gray-200 bg-white">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 md:flex-row md:items-center md:justify-between">
        <div className="space-y-1">
          <h1 className="text-2xl font-bold text-gray-900">Your Saved Jobs</h1>
          <p className="max-w-2xl text-sm text-gray-600 md:text-base">
            Track and manage jobs you've saved for later. Apply or remove as you
            wish.
          </p>
        </div>
